...
use App\Form\Filter\EducationFilterType;
...
class EducationController extends AbstractController
{
     ...
     */
    public function index(EducationRepository $educationRepository, PaginatorInterface $paginator, Request $request): Response
    {

        $pageSize = 5;

$education = new Education();
$searchForm = $this->createForm(EducationFilterType::class, $education);


$key = "";
if(    $request->query->get('education_filter')    )
{
    $key = $request->query->get('education_filter')['name'];
}

$queryBuilder = $educationRepository->filterByName($key);
